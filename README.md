...
* [Sencha Adventures](https://github.com/loiane/sencha-adventures) ⚠️ Archived - A collection of resources to learn Sencha frameworks by @loiane.
...
* [Ext Mail - Example Mail Client](https://github.com/Stuart98/ext-mail) ⭐ 11 | 🐛 1 | 🌐 JavaScript | 📅 2022-04-03 - An example email client application (classic & modern) built during Sencha Café webinar series.
...
* [ExtDirect connector for Java](https://github.com/ralscha/extdirectspring) ⭐ 127 | 🐛 0 | 🌐 Java | 📅 2026-08-15 - Implementation of the Ext Direct protocol with Java and Spring.
...
* [Ace editor integration](https://github.com/cadorn/ace-extjs) ⚠️ Archived - An exemple of integration in ExtJS of ACE code editor.
* [DateTimePicker](https://github.com/gportela85/DateTimeField) ⭐ 74 | 🐛 0 | 🌐 JavaScript | 📅 2019-08-21 - An useful widget to pick date and time.
* [Filebrowser component](https://github.com/revolunet/Ext.ux.filebrowser) ⭐ 43 | 🐛 0 | 🌐 JavaScript | 📅 2013-07-09 - A useful filebrowser component.
* [Pdf viewer panel](https://github.com/SunboX/ext_ux_pdf_panel) ⭐ 35 | 🐛 2 | 🌐 JavaScript | 📅 2014-09-27 - A pdf viewer panel.
* [Ext JS MVVM extensions](https://github.com/alexeysolonets/extjs-mvvm-extensions) ⭐ 23 | 🐛 0 | 🌐 JavaScript | 📅 2017-05-30 - Extensions for custom components with a ViewModel.
* [Ext.ux.button.DateRangePicker](https://github.com/wencywww/Ext.ux.button.DateRangePicker) ⭐ 19 | 🐛 0 | 🌐 JavaScript | 📅 2019-10-10 - Component for selecting date range in ExtJS.
* [Exportable grid](https://github.com/yorl1n/ext.ExportableGrid) ⭐ 13 | 🐛 3 | 📅 2017-01-26 - Wrapper over ExtJS's grid to make grid exportable to xslx format.
* [extjs-carto](https://github.com/CrestoneDigital/extjs-carto) ⭐ 10 | 🐛 0 | 🌐 JavaScript | 📅 2018-05-10 - Components to interact with Carto map tools.
* [ExtJS-Grid-PDF-Exporter](https://github.com/shikhirsingh/ExtJS-Grid-PDF-Exporter) ⭐ 8 | 🐛 1 | 🌐 JavaScript | 📅 2020-05-24 - Sample application to export grid content in pdf.
* [ActionColumnRowEditing](https://github.com/maltempi/extjs-action-column-row-editing) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2021-09-13 - A plugin based on Ext.grid.plugin.RowEditing changing the default floating buttons to an action column.
* [ActivityMonitor](https://github.com/Arhia/ExtJS-ActivityMonitor) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2018-07-27 - A class to track user activity.
* [Ext.ux.grid.Printer](https://github.com/Arhia/Ext.ux.grid.Printer) ⭐ 6 | 🐛 7 | 🌐 JavaScript | 📅 2022-04-25 - An ExtJS 5/6/7 Component to print grid content.
* [Ext.ux.ColorPicker](https://github.com/sw4/Ext.ux.ColorPicker) ⭐ 5 | 🐛 0 | 🌐 CSS | 📅 2014-10-13 - A beautiful colorpicker.
* [DateSlider component for Sencha ExtJS](https://github.com/OhmzTech/extjs-dateslider) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2013-04-24 - A nice date slider.
* [Nvd3 bindings](https://github.com/syslogic/extjs-nvd3-charts) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2025-08-07 - NVD3.js Bindings as Sencha ExtJS Package.
* [Ext.ux.slider.Multi.Tips](https://github.com/wencywww/Ext.ux.slider.Multi.Tips) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2017-09-27 - Override for the ExtJS multislider component to show persistent tips over the thumbs.
* [Wursta Tree Combobox](https://github.com/wursta/extjs/tree/master/app/form/field) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2019-08-08 - Tree combo component
...
* [karma-extjs](https://github.com/Unit4/karma-extjs) ⭐ 18 | 🐛 1 | 🌐 JavaScript | 📅 2017-06-23 - A tool to use karma to run unit tests on ExtJS applications.

### Icons, Themes

* [ExtJS-Material-Icons](https://github.com/RichardStyles/ExtJS-Material-Icons) ⚠️ Archived - Allow use of Material Design Iconic Font Icons in an ExtJS project. (Google icons + extended community icons).
* [ExtJS-Wheather-Icons](https://github.com/RichardStyles/ExtJS-Weather-Icons) ⚠️ Archived - ExtJS package to use [Weather icons](https://erikflowers.github.io/weather-icons/).

### Packages

* [modern-locale](https://github.com/wemersonjanuario/modern-locale) ⭐ 32 | 🐛 0 | 🌐 JavaScript | 📅 2024-08-07 - A locale package for ExtJS modern toolkit.

### Integration of ExtJS Components with other frameworks

* [Connector to Angular2](https://github.com/mgusmano/angular2-extjs) ⭐ 9 | 🐛 2 | 🌐 TypeScript | 📅 2017-03-20
...
* [Kitto2](https://github.com/EtheaDev/kitto2) ⭐ 96 | 🐛 2 | 🌐 JavaScript | 📅 2022-08-09 - A tool to build web interfaces with ExtJS 6 and Delphi.
* [Slate](https://github.com/SlateFoundation/slate) ⭐ 69 | 🐛 50 | 🌐 JavaScript | 📅 2026-07-16 - An open-source foundation for schools.
...
* [Lino](https://github.com/lino-framework/lino) ⚠️ Archived - A web application framework using Django and ExtJS.
* [DVelum](https://github.com/dvelum/dvelum) ⭐ 22 | 🐛 0 | 🌐 PHP | 📅 2022-02-06 - Professional PHP/ExtJS-based web development platform.
